...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Demo-ModellingMemories'
#
...
# Create project
create_project Demo-ModellingMemories ../vivado/Demo-ModellingMemories

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Demo-ModellingMemories]
...
set files [list \
 "[file normalize "../src_hdl/ModelledMemory.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/ModelledMemory.vhd"
...
set obj [get_filesets sources_1]
set_property "top" "ModelledMemory" $obj
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_ModelledMemory.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_ModelledMemory.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_ModelledMemory" $obj
...
puts "INFO: Project created:Demo-ModellingMemories"
