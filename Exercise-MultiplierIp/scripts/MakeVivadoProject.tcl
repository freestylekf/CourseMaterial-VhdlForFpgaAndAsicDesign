...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Exercise-MultiplierIp'
#
...
# Create project
create_project Exercise-MultiplierIp ../vivado/Exercise-MultiplierIp

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Exercise-MultiplierIp]
...
set files [list \
 "[file normalize "../src_hdl/Multiplier.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/Multiplier.vhd"
...
set obj [get_filesets sources_1]
set_property "top" "Multiplier" $obj
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_Multiplier.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_Multiplier.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_Multiplier" $obj
...
puts "INFO: Project created:Exercise-MultiplierIp"
