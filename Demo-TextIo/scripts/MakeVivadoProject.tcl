...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Demo-TextIo'
#
...
# Create project
create_project Demo-TextIo ../vivado/Demo-TextIo

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Demo-TextIo]
...
set files [list \
 "[file normalize "../src_hdl/TextIo.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/TextIo.vhd"
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_TextIo.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_TextIo.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_TextIo" $obj
...
puts "INFO: Project created:Demo-TextIo"
