...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Demo-Bitstream'
#
...
# Create project
create_project Demo-Bitstream ../vivado/Demo-Bitstream

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Demo-Bitstream]
...
set files [list \
 "[file normalize "../src_hdl/Bitstream.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/Bitstream.vhd"
...
set obj [get_filesets sources_1]
set_property "top" "Bitstream" $obj
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_Bitstream.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_Bitstream.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_Bitstream" $obj
...
puts "INFO: Project created:Demo-Bitstream"
