...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Exercise-BlockRam'
#
...
# Create project
create_project Exercise-BlockRam ../vivado/Exercise-BlockRam

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Exercise-BlockRam]
...
set files [list \
 "[file normalize "../src_hdl/BlockRam.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/BlockRam.vhd"
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_BlockRam.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_BlockRam.vhd.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_BlockRam" $obj
...
puts "INFO: Project created:Exercise-BlockRam"
