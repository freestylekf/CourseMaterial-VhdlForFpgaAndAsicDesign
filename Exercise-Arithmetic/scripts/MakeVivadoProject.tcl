...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Exercise-Arithmetic'
#
...
# Create project
create_project Exercise-Arithmetic ../vivado/Exercise-Arithmetic

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Exercise-Arithmetic]
...
set files [list \
 "[file normalize "../src_hdl/Arithmetic.vhd"]"\
 "[file normalize "../src_hdl/ArithmeticPackage.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/Arithmetic.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/ArithmeticPackage.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set obj [get_filesets sources_1]
set_property "top" "Arithmetic" $obj
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_Arithmetic.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_Arithmetic.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_Arithmetic" $obj
...
puts "INFO: Project created:Exercise-Arithmetic"
