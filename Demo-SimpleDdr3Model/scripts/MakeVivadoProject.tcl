...
#
# MakeVivadoProject.tcl: Tcl script for re-creating project 'Demo-SimpleDdr3Model'
#
...
# Create project
create_project Demo-SimpleDdr3Model ../vivado/Demo-SimpleDdr3Model

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects Demo-SimpleDdr3Model]
...
set files [list \
 "[file normalize "../src_hdl/SimpleDdr3Model.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "../src_hdl/SimpleDdr3Model.vhd"
...
set obj [get_filesets sources_1]
set_property "top" "SimpleDdr3Model" $obj
...
set files [list \
 "[file normalize "../src_hdl_tb/tb_SimpleDdr3Model.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "../src_hdl_tb/tb_SimpleDdr3Model.vhd"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property "top" "tb_SimpleDdr3Model" $obj
...
puts "INFO: Project created:Demo-SimpleDdr3Model"
